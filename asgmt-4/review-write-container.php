<section class="review_container card p-3 mb-3 d-flex flex-column justify-content-between">
  ...
  <form class="d-flex flex-column" method="post" action="<?= $_SERVER['PHP_SELF'].'?id='.$_GET['id'] ?>" onsubmit="0">
    <textarea required class="mb-3 p-2 bg-secondary border-0 text-white rounded" name='review-body' maxlength="8000"></textarea>
    <div class="mb-2 d-flex flex-row justify-content-between">
      <div class="form-check mt-t">
        <label class="form-check-label">
          <input class="form-check-input" type="checkbox" name='comments-allow' value='true' checked>Allow Comments?
        </label>
      </div>
